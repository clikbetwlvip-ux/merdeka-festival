...
/* =========================================================
   CLICKBET88 FESTIVAL KEMERDEKAAN
   JAVASCRIPT PART 7.1
   PREMIUM PANJAT PINANG GAMEPLAY ENGINE
========================================================= */
...
(() => {
    ...
    const CLIMB_CONFIG = {
        ...
        /*
         * Durasi satu permainan dalam milidetik.
         */
        gameDuration: 30000,

        /*
         * Progress yang dibutuhkan untuk menang.
         */
        finishProgress: 100,
         ...
         */
        maximumStamina: 100,
        minimumStaminaToClimb: 4,
        staminaCostPerClimb: 5.5,
        staminaRecoveryPerSecond: 12,

        /*
         * Kekuatan panjat.
         */
        minimumClimbPower: 1.8,
        normalClimbPower: 3.4,
        perfectClimbPower: 5.8,

        /*
         * Timing combo.
         */
        perfectTimingMinimum: 180,
        perfectTimingMaximum: 520,
        spamTimingLimit: 120,
        comboResetDelay: 1100,
        maximumCombo: 12,

        /*
         * Efek licin.
         */
        slipChanceNormal: 0.035,
        slipChanceTired: 0.16,
        slipDistanceMinimum: 2,
        slipDistanceMaximum: 7,

        /*
         * Kamera.
         */
        cameraMaximumOffset: 28,
        cameraFollowStrength: 0.085,

        /*
         * Selector fleksibel agar dapat menyesuaikan
        ...
        selectors: {
            screen: [
                ...
                "#panjatScreen",
                "#gamePanjatPinang",
                '[data-screen="panjat-pinang"]',
                '[data-game-screen="panjat"]'
            ],
            ...
            progressBar: [
                "#panjatProgressBar",
                "#pinangProgressBar",
                ".panjat-progress-fill",
                ".pinang-progress-fill",
                '[data-panjat-progress]'
            ],

            progressText: [
                "#panjatProgressText",
                "#pinangProgressText",
                '[data-panjat-progress-text]'
            ],
    ...
    function isPanjatScreenVisible() {
        const screen =
            state.elements.screen;
    ...
    function findGameElements() {
        const selectors =
            CLIMB_CONFIG.selectors;

        state.elements.screen =
            queryFirst(selectors.screen);

        const root =
            state.elements.screen ||
            document;

        state.elements.arena =
            queryFirst(
                selectors.arena,
                root
            ) ||
        ...
        state.elements.climbButton =
            queryFirst(
                selectors.climbButton,
                root
            );
        ...
        state.elements.progressText =
            queryFirst(
                selectors.progressText,
                root
            );

        state.elements.statusText =
            queryFirst(
                selectors.statusText,
                root
            );

        state.elements.timerText =
            queryFirst(
                selectors.timerText,
                root
            );
        ...
        style.textContent = `
            ...
            .cb88-stamina-fill {
                ...
                transition:
                    ...
                    filter .2s ease;
                box-shadow:
                    0 0 14px rgba(255, 205, 55, .45);
            }

            .cb88-stamina-fill.tired {
                filter:
                    saturate(1.4)
                    drop-shadow(
                        0 0 7px rgba(255,50,50,.7)
                    );
                animation:
                    cb88TiredPulse .45s ease-in-out
                    infinite alternate;
            }
            ...
            .cb88-combo-badge {
                ...
                min-width: 78px;
                padding: 5px 10px;
                border: 1px solid rgba(255,218,70,.55);
                border-radius: 999px;
                background:
                    linear-gradient(
                        135deg,
            ...
            .cb88-climb-feedback {
                ...
                text-align: center;
                text-shadow:
                    0 4px 0 rgba(90, 4, 13, .8),
                    0 0 18px rgba(255, 215, 70, .75);
                opacity: 0;
                transform:
                    translate(-50%, 20px)
                    scale(.7);
            ...
            .cb88-climb-feedback.perfect {
                color: #fff39b;
            }

            .cb88-climb-feedback.slip {
                color: #ff6879;
                text-shadow:
                    0 4px 0 rgba(70,0,5,.85),
                    0 0 18px rgba(255,30,55,.7);
            }

            .cb88-climb-countdown {
                position: absolute;
                inset: 0;
                z-index: 170;
                display: grid;
                ...
                color: #fff;
                font-size:
                    clamp(68px, 15vw, 150px);
                font-weight: 1000;
                line-height: 1;
                text-shadow:
                    0 8px 0 #a30b20,
                    0 0 35px rgba(255,210,50,.7);
                pointer-events: none;
            }

            .cb88-countdown-number {
                animation:
                    cb88CountdownPop .75s
                    cubic-bezier(.2,.9,.25,1);
            }
            ...
            .cb88-climb-particle {
                ...
                height: 8px;
                border-radius: 50%;
                background: rgba(238,202,126,.9);
                box-shadow:
                    0 0 8px rgba(255,220,120,.55);
                pointer-events: none;
                animation:
                    cb88ParticleFly
                    var(--particle-duration, 650ms)
                    ease-out forwards;
            }
            ...
            .cb88-finish-glow {
                ...
                background:
                    radial-gradient(
                        ...
                        rgba(255,190,40,.42) 28%,
                        rgba(255,160,20,.06) 66%,
                        transparent 72%
                    );
                opacity: 0;
                transform:
            ...
            .cb88-finish-glow.active {
                animation:
                    cb88FinishGlow 1.8s ease
                    forwards;
            }

            .cb88-character-climb-left {
                animation:
                    cb88ClimbLeft .25s
                    cubic-bezier(.3,.8,.3,1);
            }

            .cb88-character-climb-right {
                animation:
                    cb88ClimbRight .25s
                    cubic-bezier(.3,.8,.3,1);
            }
            ...
            .cb88-character-slip {
                animation:
                    cb88CharacterSlip .52s
                    cubic-bezier(.3,.1,.3,1);
            }

            .cb88-character-tired {
                animation:
                    cb88CharacterTired .75s
                    ease-in-out infinite alternate;
            }

            .cb88-character-celebrate {
                animation:
                    cb88Celebrate .58s
                    ease-in-out infinite alternate;
            }
            ...
            .cb88-camera-shake {
                animation:
                    cb88CameraShake .24s linear;
            }

            @keyframes cb88ClimbLeft {
                0% {
                    rotate: 0deg;
                    scale: 1;
                }
            ...
            @keyframes cb88ConfettiFall {
                ...
                100% {
                    ...
                    transform:
                        ...
                        rotate(
                            var(--confetti-rotation, 720deg)
                        );
                }
            }

            @keyframes cb88FinishGlow {
                0% {
                    opacity: 0;
                    transform:
                        translateX(-50%)
    ...
    function buildInterface() {
        ...
        if (!hud) {
            ...
            hud.innerHTML = `
                <div class="cb88-hud-panel">
                    <div class="cb88-hud-label-row">
                        <span>
                            STAMINA
                        </span>

                        <span
                            class="cb88-combo-badge"
                            data-cb88-combo
                        >
                            COMBO ×1
                        </span>

                        <span data-cb88-stamina-text>
                            100%
                        </span>
                    </div>

                    <div class="cb88-stamina-track">
                        <div
                            class="cb88-stamina-fill"
                            data-cb88-stamina-fill
                        ></div>
                    </div>
                </div>
            `;
        ...
        state.elements.staminaFill =
            hud.querySelector(
                "[data-cb88-stamina-fill]"
            );

        state.elements.comboText =
            hud.querySelector(
                "[data-cb88-combo]"
            );
        ...
        if (!finishGlow) {
            ...
            finishGlow.className =
                "cb88-finish-glow";

            arena.appendChild(finishGlow);
        }

        state.elements.finishGlow =
            finishGlow;
    ...
    function resetState() {
        ...
        state.progress =
            CLIMB_CONFIG.startingProgress;

        state.targetProgress =
            CLIMB_CONFIG.startingProgress;

        state.stamina =
            CLIMB_CONFIG.maximumStamina;
        ...
        state.remainingTime =
            CLIMB_CONFIG.gameDuration;

        state.lastClimbTime = 0;
        state.lastSuccessfulClimbTime = 0;

        state.cameraOffset = 0;
        state.targetCameraOffset = 0;

        state.slipping = false;
        state.reachingPrize = false;
        ...
        if (state.elements.character) {
            state.elements.character.style
                .setProperty(
                    "--cb88-climb-progress",
                    "0"
                );
    ...
    async function runCountdown() {
        ...
        for (
            ...
            countdown.innerHTML = `
                <span class="cb88-countdown-number">
                    ${value}
                </span>
            `;
    ...
    async function startGame(options = {}) {
        ...
        if (!findGameElements()) {
            console.warn(
                "[CLICKBET88 Part 7.1] Arena Panjat Pinang tidak ditemukan."
            );
        ...
        /*
         * Tiket dapat dipotong oleh engine lama.
         * Gunakan consumeTicket true hanya jika
         * ingin Part 7.1 memotong tiket sendiri.
         */
        if (options.consumeTicket === true) {
            const ticketAPI =
                window.ClickbetGame;
    ...
    function updateStamina(deltaSeconds) {
        const timeSinceLastClimb =
            performance.now() -
            state.lastClimbTime;

        if (timeSinceLastClimb > 260) {
    ...
    function updateProgress(deltaSeconds) {
        const difference =
            state.targetProgress -
            state.progress;
    ...
    function updateCharacterPosition() {
        ...
        /*
         * Menggunakan CSS custom property agar tidak
         * menimpa transform bawaan desain pengguna.
         */
    ...
    function updateCamera(deltaSeconds) {
        state.targetCameraOffset =
            ...
            CLIMB_CONFIG.cameraMaximumOffset;
        ...
        /*
         * Kamera memakai background-position agar tidak
         * mengganggu posisi tombol dan HUD.
         */
    ...
    function handleClimbInput(event) {
        if (
            event &&
        ...
        state.lastClimbTime = now;

        if (
            state.stamina <
            CLIMB_CONFIG
                .minimumStaminaToClimb
        ) {
            state.combo = 0;
        ...
        const isSpam =
            timing <
            CLIMB_CONFIG.spamTimingLimit;

        const isPerfect =
            timing >=
                CLIMB_CONFIG
                    .perfectTimingMinimum &&
            timing <=
                CLIMB_CONFIG
                    .perfectTimingMaximum;

        let climbPower =
            CLIMB_CONFIG.normalClimbPower;
    ...
    function createDustParticles(
        ...
        for (
            ...
            particle.style.setProperty(
                "--particle-y",
                `${randomBetween(20, 78)}px`
            );

            particle.style.setProperty(
                "--particle-duration",
                `${randomBetween(450, 800)}ms`
            );
    ...
    function createConfetti(
        ...
        for (
            ...
            confetti.style.setProperty(
                "--confetti-rotation",
                `${randomBetween(400, 1100)}deg`
            );

            confetti.style.setProperty(
                "--confetti-duration",
                `${randomBetween(1500, 2900)}ms`
            );

            confetti.style.animationDelay =
                `${randomBetween(0, 420)}ms`;
    ...
    async function finishGame(won) {
        ...
        if (won) {
            ...
            state.reachingPrize = true;

            setStatus("HADIAH TERCAPAI!");
    ...
    function registerResult(won) {
        ...
        /*
         * Integrasi dengan Part 6.
         */
        if (
            typeof window.ClickbetGame
                ?.registerGameResult ===
            "function"
        ) {
            window.ClickbetGame
    ...
    function handleScreenChange(event) {
        ...
        if (
            screen.includes("panjat") ||
            screen.includes("pinang")
        ) {
            window.setTimeout(() => {
                findGameElements();
                buildInterface();
    ...
    window.ClickbetClimb = {
        version:
            CLIMB_CONFIG.version,
    ...
    function initialize() {
        ...
        /*
         * Event opsional untuk tombol mulai game.
         */
        document.addEventListener(
            "clickbet:startpanjat",
            () => {
                startGame();
            }
        );
        ...
        console.info(
            "[CLICKBET88] JavaScript Part 7.1 Premium Panjat Pinang aktif."
        );
    }
